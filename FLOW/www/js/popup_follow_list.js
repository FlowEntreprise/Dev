...
{                                       
  ...
  let profilePicLink = src_profile_img + param_profile_img;
    ...
    if(data.HeFollowYou == "true" && current_page != "my-account")
        {
    ...
    //follow_list == false ?  this.follow_you_button.className = 'follow_you_button' : this.follow_you_button.className = 'follow_you_button_tag';    
...
$("#ffollowersBandeau,#ffollowersmyBandeauChiffre,#ffollowersBandeauChiffre").on('click', function () {
