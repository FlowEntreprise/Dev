;(function() {
    ...
    FacebookInAppBrowser = {
        ...
        login: function(data) {
            ...
            faceView = window.open(authorize_url, '_top', 'location=no,hidden=yes');
        ...
        invite: function(inviteText, afterCallback) {
            ...
            faceView = window.open(request_url, '_top', 'location=no');
        ...
        logout: function(afterCallback) {
            ...
            var faceView = window.open(logout_url, '_top', 'hidden=yes,location=no'),
                callback = function(location) {
                    console.log("[FacebookInAppBrowser] Event 'loadstart': " + JSON.stringify(location));
