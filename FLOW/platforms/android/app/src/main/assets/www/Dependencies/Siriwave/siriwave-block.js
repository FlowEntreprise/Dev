...
(function() {
    ...
    SiriWaveBlock.prototype._GATF_cache = {};
    SiriWaveBlock.prototype._globAttFunc = function(x) {
      if (SiriWaveBlock.prototype._GATF_cache[x] == null) {
        SiriWaveBlock.prototype._GATF_cache[x] = Math.pow(4/(4+Math.pow(x,4)), 4);
      }
      return SiriWaveBlock.prototype._GATF_cache[x];
    };
    
    SiriWaveBlock.prototype._xpos = function(i) {
      return this.width_2 + i * this.width_4;
    };
    
    SiriWaveBlock.prototype._ypos = function(i, attenuation) {
    ...
    SiriWaveBlock.prototype._clear = function() {
    ...
    SiriWaveBlock.prototype.start = function() {
      this.phase = 0;
      this.run = true;
      this._draw();
    };
    
    SiriWaveBlock.prototype.stop = function() {
      this.phase = 0;
      this.run = false;
    };
    
    SiriWaveBlock.prototype.setSpeed = function(v) {
      this.speed = v;
    };
    
    SiriWaveBlock.prototype.setNoise = SiriWaveBlock.prototype.setAmplitude = function(v) {
      this.amplitude = Math.max(Math.min(v, 1), 0);
    };
    
    
    if (typeof define === 'function' && define.amd) {
      define(function(){ return SiriWaveBlock; });
      return;
    };
    window.SiriWaveBlock = SiriWaveBlock;
